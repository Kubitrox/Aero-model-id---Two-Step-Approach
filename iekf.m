...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
E_x_0       = zeros(18, 1);  % initial estimate of optimal value of x_k1_k_1
x_0         = zeros(18, 1);  % initial true state
...
lambdaq = 0.005; % deg/s
lambdar = 0.002; % deg/s
E_w         = zeros(6, 1);           % bias of system noise
std_w       = [lambdax, lambday, lambdaz, lambdap, lambdaq, lambdar];           % standard deviations of system noise
